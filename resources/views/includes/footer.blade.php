    ...
    <div class="footer-2-1 container-xxl mx-auto position-relative p-0" style="font-family: 'Poppins', sans-serif">
      <div class="list-footer">
        <div class="row gap-md-0 gap-3">
          <div class="col-lg-3 col-md-6">
            <div class="">
              ...
              <nav class="list-unstyled">
                ...
                <li class="list-space">
                  <a href="#daftar" class="list-menu">Agenda</a>
                </li>
                <li class="list-space">
                  <a href="#lokasi" class="list-menu">Location</a>
                </li>
                <!-- <li class="list-space">
                  <a href="https://bagi.to/DaftarSposorRapimnasPII2021" class="list-menu">Sponsor</a>
                </li>
                <li class="list-space">
          ...
          <div class="col-lg-3 col-md-6">
            <h2 class="footer-text-title">Download</h2>
            <nav class="list-unstyled">
              <li class="list-space">
                <a href="" class="list-menu">Proposal</a>
              </li>
            </nav>
          </div>
          <div class="col-lg-3 col-md-6">
            <h2 class="footer-text-title">Community</h2>
            <nav class="list-unstyled">
              <li class="list-space">
                <a href="http://ristekdikti.go.id/" class="list-menu">Ristek Dikti</a>
              </li>
              <li class="list-space">
                <a href="https://afeo.org/" class="list-menu">AFEO</a>
              </li>
              <li class="list-space">
                <a href="http://www.pii.or.id/" class="list-menu">PII</a>
              </li>
            </nav>
          </div>
          <div class="col-lg-3 col-md-6">
            ...
            <nav class="list-unstyled">
              <li class="list-space">
                <a href="http://www.pii.or.id/" class="list-menu">About Us</a>
              </li>
              <li class="list-space">
                <a href="https://bagi.to/RAPIMNAS2021PII" class="list-menu">Contact Us</a>
              </li>
              <li class="list-space">
                <a href="https://bagi.to/iamPanjiHadjarati" class="list-menu">Developer</a>
              </li>
            </nav>
          </div>
        </div>
      </div>
      <div class="info-footer border-color">
        <div class="">
          <hr class="hr" />
        </div>
        <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
          <div class="d-flex title-font font-medium align-items-center gap-4">
            <a href="https://web.facebook.com/persatuaninsinyurindonesia/">
            ...
            <a href="https://twitter.com/PII_Pusat">
              <svg class="social-media-c" width="30" height="30" viewBox="0 0 30 30" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <circle cx="15" cy="15" r="15" fill="#C7C7C7" />
                <g clip-path="url(#clip0)">
            ...
            <a href="https://www.instagram.com/pii_pusat/">
          ...
          <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
            <p style="margin: 0">Copyright © 2021 RAPIMNAS PII</p>
          </nav>
        </div>
      </div>
    </div>
